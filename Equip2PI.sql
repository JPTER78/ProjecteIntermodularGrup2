...
--
-- Servidor: localhost
-- Temps de generació: 16-05-2024 a les 11:28:29
...
INSERT INTO `Peliculas` (`IDPeli`, `NomPeli`, `Genere`, `Nota`, `Any`, `Durada`, `Interprets`, `Direccio`, `Sinopsi`, `ImatgePeli`, `IDUsuario`) VALUES
(2, '[value-2]', '[value-3]', 6, 6, 6, '[value-7]', '[value-8]', '[value-9]', 0x5b76616c75652d31305d, 0);
