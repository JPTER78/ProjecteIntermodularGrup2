...
--
-- Servidor: localhost
-- Temps de generació: 22-05-2024 a les 08:15:14
...
(20, 'Se ha eliminado el usuario de id: 25 nombre: [value-2] apellido: [value-7] email: [value-3] contraseña: [value-4] población: [value-6] fecha nacimiento: 1999-09-09 imagen de perfil: [value-8] rol: [value-9]', '2024-05-22 08:07:59');
...
('Se ha eliminado la pelicula de  id: 2 nombre: [value-2] genero: [value-3] dirección: [value-8] imagen peli; [value-10] sinopsis: [value-9] interpretes: [value-7] fecha estreno: 6 duración: 6 nota: 6', '2024-05-22 08:07:53', 5);
